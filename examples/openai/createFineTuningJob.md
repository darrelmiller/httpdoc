...
[Learn more about fine-tuning](/docs/guides/fine-tuning)
</h1><p  class="requestDescription"></p></section><section  class="http"><h3>HTTP Request</h3><pre  class="httpExample"><span  class="requestLine">POST</span> <span  class="httpTarget">+{baseUrl}\fine_tuning\jobs</span> <span  class="httpVersion">HTTP/1.1</span>
