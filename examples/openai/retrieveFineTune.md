...
[Learn more about fine-tuning](/docs/guides/legacy-fine-tuning)
</h1><p  class="requestDescription"></p></section><section  class="http"><h3>HTTP Request</h3><pre  class="httpExample"><span  class="requestLine">GET</span> <span  class="httpTarget">+{baseUrl}\fine-tunes\{fine_tune_id}</span> <span  class="httpVersion">HTTP/1.1</span>
